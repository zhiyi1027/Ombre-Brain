...
class PublicToolDesignContract:
    ...
    def default(cls) -> "PublicToolDesignContract":
        return cls(
            normal_tools=frozenset({"hold", "grow", "trace", "breath", "breath_search", "breath_advanced", "pulse", "dream", "anchor", "i", "letter", "plan", "media_catalog", "media_read", "raw_day", "raw_search"}),
